...
public class ModWoodBlocks {
    ...
    public static final Block APPLESTAIRS = registerBlock("apple_stairs",(properties) -> new StairBlock(ModWoodBlocks.APPLEPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS));
    ...
    public static final Block PEARSTAIRS = registerBlock("pear_stairs",(properties) -> new StairBlock(ModWoodBlocks.PEARPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS));
    ...
    public static final Block LEMONSTAIRS = registerBlock("lemon_stairs",(properties) -> new StairBlock(ModWoodBlocks.LEMONPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS));
    ...
    public static final Block WALNUTSTAIRS = registerBlock("walnut_stairs",(properties) -> new StairBlock(ModWoodBlocks.WALNUTPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS));
    ...
    public static final Block BANANASTAIRS = registerBlock("banana_stairs",(properties) -> new StairBlock(ModWoodBlocks.BANANAPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS));
    ...
    public static final Block PEACHSTAIRS = registerBlock("peach_stairs",(properties) -> new StairBlock(ModWoodBlocks.PEACHPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS));
    ...
    public static final Block COCONUTSTAIRS = registerBlock("coconut_stairs",(properties) -> new StairBlock(ModWoodBlocks.COCONUTPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS));
    ...
    public static final Block CARAMBOLASTAIRS = registerBlock("carambola_stairs",(properties) -> new StairBlock(ModWoodBlocks.CARAMBOLAPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS));
    ...
    public static final Block TOONSTAIRS = registerBlock("toon_stairs",(properties) -> new StairBlock(ModWoodBlocks.TOONPLANKS.defaultBlockState(),properties),BlockBehaviour.Properties.copy(Blocks.SPRUCE_PLANKS));
    ...
    public static void register() {
        for (Map.Entry<String, Block> entry : ModWoodBlocks.BLOCK_MAP.entrySet()) {
