...
import dev.anvilcraft.fooding.init.fooddata.FruitsData;
...
//    public final static Item BLUEBERRY = registerItem("blueberry",Item::new,defaultProperties().food(lobster.moe.anvilcook.item.ModFruit.BLUEBERRY));
    public final static Item STRAWBERRY = registerItem("strawberry",(properties)->new ItemNameBlockItem(ModCrops.STRAWBERYCROP, new Item.Properties().food(FruitsData.STRAWBERRY)),defaultProperties().food(FruitsData.STRAWBERRY));
    public final static Item BLUEBERRY = registerItem("blueberry",(properties)->new ItemNameBlockItem(ModCrops.BLUEBERYCROP, new Item.Properties().food(FruitsData.BLUEBERRY)),defaultProperties().food(FruitsData.BLUEBERRY));
