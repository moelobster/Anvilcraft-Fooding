package dev.anvilcraft.fooding.feature.features;
...
public class ModTreeFeatures{
    ...
    private static TreeConfiguration.TreeConfigurationBuilder createApple(){
        return createStraightBlobTree(ModWoodBlocks.APPLELOG, ModWoodBlocks.APPLELEAVES,5,3,0,2).ignoreVines();
    }
    private static TreeConfiguration.TreeConfigurationBuilder createPear() {
        return createStraightBlobTree(ModWoodBlocks.PEARLOG, ModWoodBlocks.PEARLEAVES, 5, 3, 0, 3).ignoreVines();
    }
    private static TreeConfiguration.TreeConfigurationBuilder createLemon() {
        return createStraightBlobTree(ModWoodBlocks.LEMONLOG, ModWoodBlocks.LEMONLEAVES, 5, 2, 0, 3).ignoreVines();
    }
    private static TreeConfiguration.TreeConfigurationBuilder createWalnut() {
        return createStraightBlobTree(ModWoodBlocks.WALNUTLOG, ModWoodBlocks.WALNUTLEAVES, 6, 3, 0, 3).ignoreVines();
    }
    private static TreeConfiguration.TreeConfigurationBuilder createBanana() {
        return createStraightBlobTree(ModWoodBlocks.BANANALOG, ModWoodBlocks.BANANALEAVES, 7, 4, 0, 4).ignoreVines();
    }
    private static TreeConfiguration.TreeConfigurationBuilder createPeach() {
        return createStraightBlobTree(ModWoodBlocks.PEACHLOG, ModWoodBlocks.PEACHLEAVES, 5, 2, 0, 2).ignoreVines();
    }
    private static TreeConfiguration.TreeConfigurationBuilder createCoconut() {
        return createStraightBlobTree(ModWoodBlocks.COCONUTLOG, ModWoodBlocks.COCONUTLEAVES, 7, 2, 0, 3).ignoreVines();
    }
    private static TreeConfiguration.TreeConfigurationBuilder createCarambola() {
        return createStraightBlobTree(ModWoodBlocks.CARAMBOLALOG, ModWoodBlocks.CARAMBOLALEAVES, 6, 2, 0, 3).ignoreVines();
    }
    private static TreeConfiguration.TreeConfigurationBuilder createToon() {
        return createStraightBlobTree(ModWoodBlocks.TOONLOG, ModWoodBlocks.TOONLEAVES, 7, 2, 0, 2).ignoreVines();
    }
